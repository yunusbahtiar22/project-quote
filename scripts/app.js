  ...
  return (
    <form className="radio-group">
      ...
      <label className="radio-group__control radio-group__control--icon" htmlFor="development">
        <input type="radio" className="radio-group__radio radio-group--invisible" name="services" id="development" />
      ...
      <label className="radio-group__control radio-group__control--icon" htmlFor="design">
        <input type="radio" className="radio-group__radio radio-group--invisible" name="services" id="design" />
        <div className="icon-container">
      ...
      <label className="radio-group__control radio-group__control--icon" htmlFor="marketing">
        <input type="radio" className="radio-group__radio radio-group--invisible" name="services" id="marketing" />
        <div className="icon-container">
      ...
      <label className="radio-group__control radio-group__control--icon" htmlFor="other">
        <input type="radio" className="radio-group__radio radio-group--invisible" name="services" id="other" />
        <div className="icon-container">
